...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      ...
      <div class="carousel-caption">
        <h1>Travel Go Memberikan pilihan Maskapai dan Kereta Terbaik untuk Perjalanan Anda</h1>
      </div>
    </div>
  </div>
              ...
              <div class="tab-pane active" id="pesawat">
                <form action="{{ url('booking/search') }}" method="post">
                  ...
                  <div class="col-md-4"><br>
                    ...
                    <br><center><p>Repost by <a href='' title='' target='_blank'>Templates Free</a></p></center>
  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Why Booking with Travel Go?</h2>
        </div>
    </div>
